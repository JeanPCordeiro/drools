...
#	curl -s -u 'kieserver:kieserver1!' -d " {\"Conducteur\" : {\"Points\" : 2}, \"Infraction\" : {\"Type\" : \"Vitesse\", \"Vitesse\" : 125, \"Vitesse_Limite\" : 100}}" -H "accept: application/json" -H "content-type: application/json" -X POST "https://kie-server.drools.lean-sys.com/kie-server/services/rest/server/containers/Permis_Conduire_1.0.0-SNAPSHOT/dmn/models/Regles_Permis_Conduire" | jq .
	curl -s -u 'kieserver:kieserver1!' -d " {\"Driver\" : {\"Points\" : 2}, \"Violation\" : {\"Type\" : \"parking\"}}" -H "accept: application/json" -H "content-type: application/json" -X POST "https://kie-server.drools.lean-sys.com/kie-server/services/rest/server/containers/TraficViolation_1.0.0-SNAPSHOT/dmn/models/Traffic Violation" | jq .
	curl -s -u 'kieserver:kieserver1!' -d " {\"Driver\" : {\"Points\" : 1}, \"Violation\" : {\"Type\" : \"parking\"}}" -H "accept: application/json" -H "content-type: application/json" -X POST "https://kie-server.drools.lean-sys.com/kie-server/services/rest/server/containers/TraficViolation_1.0.0-SNAPSHOT/dmn/models/Traffic Violation" | jq .
